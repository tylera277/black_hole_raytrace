...
img = Image.open('../pictures/fries.png')
...
angle_data = pd.read_csv('../outputs/angles_rkf4_openmp_JULY12.csv')
...
print("MAX1(horiz):", angle_data_cleaned['camera_pixel_from_left'].max())
print("Min1(horiz):", angle_data_cleaned['camera_pixel_from_left'].min())

print("MAX2(vert):", angle_data_cleaned['camera_pixel_from_bottom'].max())
print("Min2(vert):", angle_data_cleaned['camera_pixel_from_bottom'].min())
